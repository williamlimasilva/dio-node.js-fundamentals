...
- **JavaScript**: Linguagem de programação utilizada para desenvolver a lógica do carrinho de compras.
- **Node.js**: Ambiente de execução para JavaScript no lado do servidor.
- **NPM**: Gerenciador de pacotes utilizado para instalar dependências.

## 📚 Detalhes das Técnicas

- **Manipulação de Arrays**: Utilizada para armazenar e gerenciar os itens do carrinho.
- **Funções**: Criadas para adicionar, remover e calcular o total dos itens no carrinho.
- **Modularização**: Código organizado em módulos para melhor manutenção e reutilização.

## 🏗️ Padrão de Projeto Utilizado

- **Module Pattern**: Utilizado para encapsular o código em módulos, permitindo uma melhor organização e reutilização do código.
